...
with colL:
    ...
    # Filtrar carreras si universidad es válida
    if uni != "Otra":
        ...
        if car_norm:
            ...
            car = posibles_carreras[0] if posibles_carreras else car_input  # si no encuentra, deja lo escrito
        else:
